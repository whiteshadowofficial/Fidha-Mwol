...
Asena.addCommand({on: 'text', fromMe: false }, (async (message, match) => {
    if(Config.BGMFILTER){
        ...
        if (!!message.mention && message.mention[0] == '917025967090@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./media/uploads/help.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./media/uploads/' + a + '.mp3'), MessageType.audio, {contextInfo: { forwardingScore: 5, isForwarded: true }, mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
    ...
    Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {   
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '917025967090@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./media/files/help.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration:9999999,contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.AFNN) {
await message.client.sendMessage(message.jid, fs.readFileSync('./media/files/help.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        var uri = encodeURI(match[1])
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./media/files/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration:9999999,contextInfo: { forwardingScore: 3, isForwarded: true },quoted: message.data, ptt: true})
}
});
    }
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '917025967090@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./media/stickers/help.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
